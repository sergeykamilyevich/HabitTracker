...
import com.example.habittracker.data.db.room.HabitDaoFake
import com.example.habittracker.data.repositories.DbHabitRepositoryImpl.Companion.ITEM_NOT_ADDED
...
internal class DbHabitRepositoryImplTest {
    ...
    fun setUp() {
        ...
        dbHabitRepositoryImpl = DbHabitRepositoryImpl(habitDaoFake)
