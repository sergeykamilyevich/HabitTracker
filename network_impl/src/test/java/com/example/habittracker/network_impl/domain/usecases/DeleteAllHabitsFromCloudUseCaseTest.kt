...
import com.example.habittracker.network_api.domain.usecases.DeleteAllHabitsFromCloudUseCase
...
internal class DeleteAllHabitsFromCloudUseCaseTest {
    ...
    fun setUp() {
        ...
        deleteAllHabitsFromCloudUseCase = DeleteAllHabitsFromCloudUseCase(cloudHabitRepositoryFake::deleteAllHabits)
    }
