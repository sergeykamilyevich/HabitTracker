...
import com.example.habittracker.network_api.domain.usecases.DeleteHabitFromCloudUseCase
...
internal class DeleteHabitFromCloudUseCaseTest {
    ...
    fun setUp() {
        ...
        deleteHabitFromCloudUseCase = DeleteHabitFromCloudUseCase(cloudHabitRepositoryFake::deleteHabit)
